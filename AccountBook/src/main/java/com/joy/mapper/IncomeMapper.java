...
public interface IncomeMapper {
	...
	public List<DateIncomeVO> getNewCus(@Param("designer_id") String designer_id, @Param("date") String date);
	public List<DateIncomeVO> getOldCus(@Param("designer_id") String designer_id, @Param("date") String date);
